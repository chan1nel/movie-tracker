...
export default function GoogleSignInButton() {
  ...
  const handleSignIn = async () => {
    if (!provider || !auth) {
      setError("Firebase Authentication is not initialized properly. Please check your API keys.");
      console.error("Firebase Auth or Provider is undefined. Initialization likely failed.");
      return;
    }
